...
<!-- Strani DJ -->
  <!-- Prvi red -->
    <!--Yellowheads -->
     <!-- Mythrill -->
<a href="Generator.php?dj=YellowHeads" class="mirko"  alt="Yellowheads" target="_blank">
  <div class="card">
    <div class="wrapper">
      <img src="https://i1.sndcdn.com/avatars-000712960906-xumar9-t500x500.jpg" class="cover-image" />
    </div>
    <img src="./Slike/Dj-s/Yellowheads/Yellowhead-popup.png" class="character" />
  </div>
</a>
...
<a href="Generator.php?dj=carlcox" alt="Carl Cox" target="_blank">
  <div class="card">
    ...
    <img src="Slike/Dj-s/CarlCox/Carlcox.jpg" class="character" />
  </div>
</a>
...
<a href="generator.php?dj=ninakraviz" alt="Nina Kraviz" target="_blank">
  ...
  <!-- Deveti red -->
      ...
      <a href="generator.php?dj=" alt="Mythrill" target="_blank">
        <div class="card">
          <div class="wrapper">
          <img src="Zavrsni-main/GlavnaStranica/Slike/Dj-s/Umek/umek.jpg" class="cover-image" />
          </div>
          <img src="./Slike/umek.png" class="character" />
        </div>
      </a>
